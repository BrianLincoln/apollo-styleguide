            ...
            <div className="row">
                <div className="col-xs-12 col-md-6">
                    ...
                    <label htmlFor="button-details-checkbox">
                        ...
                        <a className="button button_bluewood">Tiny</a>
                        <a className="button button_porcelain">Another Button</a>
                        <a className="button button_transparent">No Background</a>
                    </label>
                    <div className="style-detail">
                        <pre className="bg-porcelain">.button.button_mariner</pre>
                        <pre className="bg-porcelain">.button.button_bluewood</pre>
                        <pre className="bg-porcelain">.button.button_porcelain</pre>
                        <pre className="bg-porcelain">.button.button_transparent</pre>
                    </div>
                </div>
                <div className="col-xs-12 col-md-6">
                    ...
                    <div className="style-detail">
                        <pre className="bg-porcelain">.button_sm.button_mariner</pre>
                        <pre className="bg-porcelain">.button_sm.button_bluewood</pre>
                        <pre className="bg-porcelain">.button_sm.button_porcelain</pre>
                        <pre className="bg-porcelain">.button_sm.button_transparent</pre>
                    </div>
                </div>
            </div>
        </section>
